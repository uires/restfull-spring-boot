...
public class Endereco implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((lougadouro == null) ? 0 : lougadouro.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (complemento == null) {
			...
			return false;
		if (lougadouro == null) {
			if (other.lougadouro != null)
				return false;
		} else if (!lougadouro.equals(other.lougadouro))
			return false;
		if (numero == null) {
	...
	public String toString() {
		return "Endereco [rua=" + rua + ", bairro=" + bairro + ", cep=" + cep + ", lougadouro=" + lougadouro
